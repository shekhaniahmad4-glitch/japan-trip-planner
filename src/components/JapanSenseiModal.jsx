...
import { Volume2, Sparkles, MessageCircle, X, Compass, Utensils, Train, HelpCircle, Check } from 'lucide-react'
                ...
                {tab === 'phrasebook' && (
                  <div className="space-y-3">
                    <p className="text-xs text-gray-500 italic">
                      Click the speaker button on any phrase to hear real authentic Japanese pronunciation with accent:
                    </p>
                    ...
                    <div className="grid sm:grid-cols-2 gap-3">
                      {PHRASES.map((item, idx) => (
                        <div
                          key={idx}
                          className="bg-white p-3.5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all flex items-start justify-between gap-3 group"
                        >
