...
export default function CurrencyConverterWidget() {
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/70 backdrop-blur-md">
          <motion.div
            ...
            className="bg-indigo-950 text-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden border border-amber-400/30 flex flex-col relative"
          >
            {/* Header */}
            ...
            <div className="p-4 bg-indigo-900/50 border-t border-white/10 flex justify-end">
              <button
                onClick={() => setIsOpen(false)}
                className="px-6 py-2.5 bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-white rounded-xl text-xs font-bold shadow-lg transition-all"
              >
                Done
              </button>
            </div>
  ...
  return (
    <>
      ...
      {/* Render modal directly into document.body with React Portal */}
