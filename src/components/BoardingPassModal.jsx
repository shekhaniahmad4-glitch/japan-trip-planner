...
export default function BoardingPassModal({ itinerary, tripData }) {
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/70 backdrop-blur-md">
          <motion.div
            ...
            className="bg-slate-900 text-white rounded-3xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto border border-white/20 flex flex-col relative"
          >
            {/* Header */}
            <div className="p-5 border-b border-white/10 flex items-center justify-between bg-slate-950 sticky top-0 z-10">
            ...
            <div className="p-5 border-t border-white/10 bg-slate-950 flex items-center justify-between sticky bottom-0">
  ...
  return (
    <>
      ...
      {/* Render modal directly in document.body */}
